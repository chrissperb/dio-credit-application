...
<p>Este repositório simula um programa <strong>API REST SPRING BOOT E KOTLIN</strong> de análise de solicitação de crédito, para a empresa fornecer aos seus clientes as seguintes funcionalidades:</p>
...
<h3>Observação</h3>
<p>Este projeto foi desenvolvido como entrega dentro do bootcamp da Dio.me chamado Desenvolvimento Backend com Kotlin, tendo como mentora a profa. Camila Cavalcante (informações abaixo). </p>
